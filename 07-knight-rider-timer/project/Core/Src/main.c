...
int main(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, ledPins[currentLedIndex], GPIO_PIN_SET);
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  {
    HAL_GPIO_WritePin(GPIOD, ledPins[currentLedIndex], GPIO_PIN_RESET);

    currentLedIndex += ledDirection;
